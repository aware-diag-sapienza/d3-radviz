...
system.settings = (function() {
    ...
    this.newDataset = function(loadfile, nameDataset) {
        ...
        d3.csv(loadfile).then(dataset => {
            ...
            const csv = `${system.data.LINK_SERVER}data/${nameDataset}.csv`
            const json = `${system.data.LINK_SERVER}data/json/${nameDataset}.json`
            system.data.load(csv, json, nameDataset);
